...
type ClassFile struct {
	// magic 校验通过的 ClassFile 的 magic 都一样，不用记录了
	//magic        uint32
	minorVersion uint16
	majorVersion uint16
...
func (this *ClassFile) read(reader *ClassReader) {
	...
	this.fields = readMember(reader, this.constantPool)
	this.methods = readMember(reader, this.constantPool)
...
func (this *ClassFile) readAndCheckVersion(reader *ClassReader) {
	...
	if this.majorVersion < 45 && this.majorVersion > 52 {
		panic("java.lang.UnsupportedClassVersionError: majorVersion!")
	}
